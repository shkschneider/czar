...
__attribute__((unused)) static unsigned long long cz_monotonic_clock_ns(void) {
#ifdef _WIN32
...
#define cz_now_monotonic_ns cz_monotonic_clock_ns

/* Sleep for specified nanoseconds */
__attribute__((unused)) static void cz_sleep_ns(unsigned long long nanoseconds) {
#ifdef _WIN32
...
int main(void) {
    ...
    printf("Result: %d\n", result);
    printf("Time taken: %llu ns (%llu µs, %llu ms)\n\n",
