...
void demo_go_style(const int32_t* values, size_t values_count);
void demo_traditional(const int32_t* values, size_t values_count);
int32_t main();

void demo_go_style(const int32_t* values, size_t values_count)
{
    _cz_printf("Go-style varargs received %d values\n", 3);
}

void demo_traditional(const int32_t* values, size_t values_count)
{
    _cz_printf("Traditional varargs received %d values\n", 3);
}

int32_t main()
{
    _cz_printf("=== Varargs Syntax Demo ===\n");
    demo_go_style((int32_t[]){10, 20, 30}, 3);
    demo_traditional((int32_t[]){40, 50, 60}, 3);
    _cz_printf("Both syntaxes are supported!\n");
    return 0;
}
