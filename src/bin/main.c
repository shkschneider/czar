...
extern const char luaJIT_BC_typechecker_inference[];
...
extern const size_t luaJIT_BC_typechecker_inference_size;
...
int main(int argc, char **argv) {
    ...
    if (load_module(L, "lexer", luaJIT_BC_lexer_init, luaJIT_BC_lexer_init_size) != 0 ||
        ...
        load_module(L, "typechecker.inference", luaJIT_BC_typechecker_inference, luaJIT_BC_typechecker_inference_size) != 0 ||
